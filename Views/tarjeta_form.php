...
<form action="/MoviePass/Compras/creditCardFunction" method="post" id="paymentForm">
   ...
   <h3>Detalles de la tarjeta</h3>
     <div>
       <div>
         ...
         <input id="cardholderName" data-checkout="cardholderName" type="text" value="matias">
       </div>
       <div>
       ...
       <div>
         ...
         <input type="text" id="cardNumber" data-checkout="cardNumber"
           onselectstart="return false" onpaste="return false"
           oncopy="return false" oncut="return false"
           ondrag="return false" ondrop="return false" autocomplete=off value="5031755734530604">
       </div>
       <div>
...
<script> window.Mercadopago.setPublishableKey("TEST-f0de3c39-fcbf-47a1-a0f1-0151a7c1246b"); 
