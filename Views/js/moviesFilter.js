        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(parse,function(key,value){
                    var str="<div class='col-md-3'><button type='button' class='btn' onClick=\"dataChange('"+value["poster"]+"','"+value["title"]+"','"+value["synopsis"]+"')\" data-id=\""+value["id"]+"\" data-toggle='modal' data-target='.movie' >";
