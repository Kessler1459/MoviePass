            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(parse, function (key, value) {
                        ...
                        str += "<figure class='figure'><img class='figure-img img-fluid rounded' src=\"https://image.tmdb.org/t/p/w154" + value["poster"] + "\" width=60% ><figcaption class='figure-caption'>" + value["title"] + "</figcaption></figure>";
                        str += "</button></div>";
